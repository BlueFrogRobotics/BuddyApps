...
public class SoundDetector : MonoBehaviour, IDetector
{
    ...
    {
        /*AudioClip[] tabAudio= new AudioClip[3];
        tabAudio[0] = mClipBefore;
        tabAudio[1] = mClipMedium;
        tabAudio[2] = _clipRecord;*/
        SavWav.Save(iFileName, Combine(mArrayAudioClip));//_clipRecord);
    }
