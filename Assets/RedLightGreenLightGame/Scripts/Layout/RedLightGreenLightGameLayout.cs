...
{
    public class RedLightGreenLightGameLayout : AWindowLayout
    {
        ...
        {		
             ...
             */ 
            mGaugeValOne.Slider.value = RedLightGreenLightGameData.Instance.MyValue;
            ...
            */
            mGaugeValOne.OnUpdateEvent((iVal) => {
				RedLightGreenLightGameData.Instance.MyValue = iVal;
			});
		}
