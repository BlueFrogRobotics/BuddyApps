...
namespace BuddyApp.Companion
{
	...
	/// </summary>
	/// 
	[RequireComponent(typeof(StimuliManager))]
	public abstract class AStateMachineBehaviour : StateMachineBehaviour
    {

		protected StimuliManager mSensorManager;

		protected Text mState;
        ...
        private CompanionStateMachineManager mManager;
        ...
        internal CompanionStateMachineManager Manager { set { mManager = value; } }
