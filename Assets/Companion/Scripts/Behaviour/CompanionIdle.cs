...
namespace BuddyApp.Companion
{
    ...
    public class CompanionIdle : AStateMachineBehaviour
    {
        ...
        public override void OnStateEnter(Animator iAnimator, AnimatorStateInfo iStateInfo, int iLayerIndex)
        {
            ...
            //Perception.Stimuli.mStimuliControllers[StimulusEvent.REGULAR_ACTIVATION_MINUTE].StartListenning();
            ...
            //Perception.Stimuli.mStimuliControllers[StimulusEvent.POSITION_UPDATE].StartListenning();
        ...
        public override void OnStateExit(Animator iAnimator, AnimatorStateInfo iStateInfo, int iLayerIndex)
        {
            ...
            //Perception.Stimuli.mStimuliControllers[StimulusEvent.REGULAR_ACTIVATION_MINUTE].StopListenning();
            ...
            //Perception.Stimuli.mStimuliControllers[StimulusEvent.POSITION_UPDATE].StopListenning();
