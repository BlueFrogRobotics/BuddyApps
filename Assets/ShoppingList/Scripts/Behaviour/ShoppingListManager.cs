...
namespace BuddyApp.ShoppingList
{
    ...
    public class ShoppingListManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            mListSerializer = ListSerializer.Deserialize(Path.Combine(Application.persistentDataPath, "shopping_items.xml"));// BuddyTools.Utils.GetStreamingAssetFilePath("shopping_items.xml"));
        ...
        public void QuitApplication()
        {
            if (!mWillQuit)
            {
                ...
                mListSerializer.Serialize(Path.Combine(Application.persistentDataPath, "shopping_items.xml"));// BuddyTools.Utils.GetStreamingAssetFilePath("shopping_items.xml"));
                CloseWindow();
                mWillQuit = true;
                mTimer = 0.0f;
