...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.AutomatedTest namespace for every script file
/// </summary>
namespace BuddyApp.AutomatedTest
{
    ...
    {
        private AutomatedTestStateMachineManager mManager;
        private Animator mAnimator;

        internal AutomatedTestStateMachineManager Manager { set { mManager = value; } }
