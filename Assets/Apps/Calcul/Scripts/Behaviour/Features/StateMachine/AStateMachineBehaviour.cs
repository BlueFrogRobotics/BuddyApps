...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.Calcul namespace for every script file
/// </summary>
namespace BuddyApp.Calcul
{
    ...
    {
        private CalculStateMachineManager mManager;
        private Animator mAnimator;

        internal CalculStateMachineManager Manager { set { mManager = value; } }
