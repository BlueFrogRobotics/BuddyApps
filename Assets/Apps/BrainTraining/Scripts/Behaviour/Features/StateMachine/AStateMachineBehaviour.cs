...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.BrainTraining namespace for every script file
/// </summary>
namespace BuddyApp.BrainTraining
{
    ...
    {
        private BrainTrainingStateMachineManager mManager;
        private Animator mAnimator;

        internal BrainTrainingStateMachineManager Manager { set { mManager = value; } }
