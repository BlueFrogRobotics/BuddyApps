...
namespace BuddyApp.BrainTraining
{
    ...
    public class StartTrainingState : AStateMachineBehaviour
    {
        private BrainTrainingBehaviour mBrainTrainingBehaviour;
        private bool mSettingsOpened;
        ...
        {
            mBrainTrainingBehaviour.LoadCategories();

            Buddy.Vocal.SayKey("welcome", output =>
            {
                if (!mSettingsOpened)
                {
