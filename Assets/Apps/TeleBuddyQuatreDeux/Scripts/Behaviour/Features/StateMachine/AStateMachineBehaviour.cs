...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.CoursTelepresence namespace for every script file
/// </summary>
namespace BuddyApp.TeleBuddyQuatreDeux
{
    ...
    {
        private TeleBuddyQuatreDeuxStateMachineManager mManager;
        private Animator mAnimator;
        private Animator mGUIAnimator;

        internal TeleBuddyQuatreDeuxStateMachineManager Manager { set { mManager = value; } }
        ...
        /// </summary>
        /// <param name="iTriggerName">Trigger name</param>
        protected void TriggerGUI(string iTriggerName)
        {
            mGUIAnimator.SetTrigger(iTriggerName);
        }
