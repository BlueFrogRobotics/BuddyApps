...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.BuddyLab namespace for every script file
/// </summary>
namespace BuddyApp.ExperienceCenter
{
    ...
    public abstract class AStateMachineBehaviour : StateMachineBehaviour
    {
        ...
        private ExperienceCenterStateMachineManager mManager;
        private Animator mAnimator;

        internal ExperienceCenterStateMachineManager Manager { set { mManager = value; } }
