...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.OutOfBox namespace for every script file
/// </summary>
namespace BuddyApp.OutOfBox
{
    ...
    public sealed class OutOfBoxStateMachineManager : MonoBehaviour
    {
        [SerializeField]
