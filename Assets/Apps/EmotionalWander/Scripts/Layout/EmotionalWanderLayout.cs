...
{
    public class EmotionalWanderLayout : AWindowLayout
    {
        ...
        {		
             ...
             */ 
            mGaugeValOne.Slider.value = EmotionalWanderData.Instance.MyValue;
            ...
            */
            mGaugeValOne.OnUpdateEvent((iVal) => {
				EmotionalWanderData.Instance.MyValue = iVal;
			});
		}
