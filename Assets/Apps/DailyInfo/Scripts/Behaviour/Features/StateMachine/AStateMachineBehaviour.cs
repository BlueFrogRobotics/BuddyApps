...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.DailyInfo namespace for every script file
/// </summary>
namespace BuddyApp.DailyInfo
{
    ...
    {
        private DailyInfoStateMachineManager mManager;
        private Animator mAnimator;

        internal DailyInfoStateMachineManager Manager { set { mManager = value; } }
