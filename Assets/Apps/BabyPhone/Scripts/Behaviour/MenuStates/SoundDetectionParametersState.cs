    ...
    public sealed class SoundDetectionParametersState : AStateMachineBehaviour
    {
        ...
        private void ShowToaster()
        {
            ...
            Buddy.GUI.Toaster.Display<ParameterToast>().With((iBuilder) =>
            {
                ...
                mSliderToggle.ToggleValue = BabyPhoneData.Instance.SoundDetection;
                mSliderToggle.SlidingValue = BabyPhoneData.Instance.SoundDetectionThreshold;
        ...
        {
            BabyPhoneData.Instance.SoundDetection = mSliderToggle.ToggleValue;
            BabyPhoneData.Instance.SoundDetectionThreshold = (int)mSliderToggle.SlidingValue;
        }
