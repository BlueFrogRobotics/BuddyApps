...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.BabyPhone namespace for every script file
/// </summary>
namespace BuddyApp.BabyPhone
{
    ...
    {
        private BabyPhoneStateMachineManager mManager;
        private Animator mAnimator;

        internal BabyPhoneStateMachineManager Manager { set { mManager = value; } }
