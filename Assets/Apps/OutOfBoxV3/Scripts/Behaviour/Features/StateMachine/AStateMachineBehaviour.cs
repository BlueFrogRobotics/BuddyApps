...
namespace BuddyApp.OutOfBoxV3
{
    ...
    {
        private OutOfBoxV3StateMachineManager mManager;
        private Animator mAnimator;

        internal OutOfBoxV3Behaviour mBehaviour;
        internal OutOfBoxV3StateMachineManager Manager { set { mManager = value; } }
