...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.HumanCounter namespace for every script file
/// </summary>
namespace BuddyApp.HumanCounter
{
    ...
    {
        private HumanCounterStateMachineManager mManager;
        private Animator mAnimator;

        internal HumanCounterStateMachineManager Manager { set { mManager = value; } }
