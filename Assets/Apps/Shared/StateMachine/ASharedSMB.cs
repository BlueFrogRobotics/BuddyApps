...
namespace BuddyApp.Shared
{
    ...
    /// </summary>
    public abstract class ASharedSMB : StateMachineBehaviour
    {
        private SharedStateMachineManager mManager;
        private Animator mAnimator;

        internal SharedStateMachineManager Manager { set { mManager = value; } }
