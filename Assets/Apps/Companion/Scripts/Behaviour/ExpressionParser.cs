...
namespace BuddyApp.Companion
{
	...
	public class ExpressionParser
	{
		...
		public ExpressionParser()
		{
			...
			m_Funcs.Add("√ ", (p) => System.Math.Sqrt(p.FirstOrDefault()));
			m_Funcs.Add("sqrt ", (p) => System.Math.Sqrt(p.FirstOrDefault()));
			m_Funcs.Add("racine de ", (p) => System.Math.Sqrt(p.FirstOrDefault()));
			m_Funcs.Add("abs ", (p) => System.Math.Abs(p.FirstOrDefault()));
			m_Funcs.Add("log ", (p) => System.Math.Log(p.FirstOrDefault()));
		...
		public bool ValidIdentifier(string aExpression)
		{
			aExpression = aExpression.Trim();
