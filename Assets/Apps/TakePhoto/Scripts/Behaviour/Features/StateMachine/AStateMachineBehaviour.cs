...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.TakePhoto namespace for every script file
/// </summary>
namespace BuddyApp.TakePhoto
{
    ...
    {
        private TakePhotoStateMachineManager mManager;
        private Animator mAnimator;

        internal TakePhotoStateMachineManager Manager { set { mManager = value; } }
