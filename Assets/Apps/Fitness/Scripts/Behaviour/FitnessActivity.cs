...
namespace BuddyApp.Fitness
{
    ...
    public class FitnessActivity : AAppActivity
    {
		/*
		...
		*/
		...
		{ 
			ExtLog.I(ExtLogModule.APP, typeof(FitnessActivity), LogStatus.START, LogInfo.LOADING, "On loading...");
		}
		...
		*/
        ...
        {
            ExtLog.I(ExtLogModule.APP, typeof(FitnessActivity), LogStatus.START, LogInfo.RUNNING, "On awake...");
        }
		...
		*/
        ...
        {
            ExtLog.I(ExtLogModule.APP, typeof(FitnessActivity), LogStatus.SUCCESS, LogInfo.LOADING, "On start...");
        }
