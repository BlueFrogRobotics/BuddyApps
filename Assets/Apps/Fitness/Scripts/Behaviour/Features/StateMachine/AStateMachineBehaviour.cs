...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.Fitness namespace for every script file
/// </summary>
namespace BuddyApp.Fitness
{
    ...
    {
        private FitnessStateMachineManager mManager;
        private Animator mAnimator;

        internal FitnessStateMachineManager Manager { set { mManager = value; } }
