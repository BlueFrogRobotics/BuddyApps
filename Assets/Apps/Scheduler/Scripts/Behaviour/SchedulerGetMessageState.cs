...
namespace BuddyApp.Scheduler
{
    ...
    public sealed class SchedulerGetMessageState : AStateMachineBehaviour
    {
        ...
        private void HybridResult(SpeechInput iSpeechInput)
        {
            ...
            Debug.LogWarning("Hybrid Rule SPEECH.ToString: " + lRule);
            Debug.LogWarning("Hybrid Msg SPEECH.Utterance: " + iSpeechInput.Utterance);
        ...
        private void DisplayMessageEntry()
        {
            ...
            if (null == mRecordedMsg) {
                ...
                Buddy.GUI.Toaster.Display<ParameterToast>().With(
                    ...
                    () => {
                        Debug.LogWarning("VALIDATE WITH BUTTON");
                        Debug.LogWarning("VALIDATE WITH BUTTON SchedulerDateManager.GetInstance().SchedulerMsg " + SchedulerDateManager.GetInstance().SchedulerMsg);
                        Debug.LogWarning("VALIDATE WITH BUTTON SchedulerDateManager.GetInstance().SchedulerRule " + SchedulerDateManager.GetInstance().SchedulerRule);
        ...
        {
            Debug.LogWarning("!!!!!VALIDATE MESSAGE WITH BUTTON");
            StopAllCoroutines();
            Buddy.Vocal.StopAndClear();
            ...
            Debug.LogWarning("mScheduledTask SAVED:" + SchedulerDateManager.GetInstance().SchedulerMsg);
            Debug.LogWarning("mScheduledTask SAVED:" + SchedulerDateManager.GetInstance().SchedulerDate.ToShortDateString() + " at " + SchedulerDateManager.GetInstance().SchedulerDate.ToLongTimeString());
            Debug.LogWarning("mScheduledTask SAVED:" + SchedulerDateManager.GetInstance().RepetitionTime);
