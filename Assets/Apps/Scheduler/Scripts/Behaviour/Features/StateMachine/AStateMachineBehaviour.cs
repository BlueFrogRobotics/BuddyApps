...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.Scheduler namespace for every script file
/// </summary>
namespace BuddyApp.Scheduler
{
    ...
    {
        private SchedulerStateMachineManager mManager;
        private Animator mAnimator;

        internal SchedulerStateMachineManager Manager { set { mManager = value; } }
