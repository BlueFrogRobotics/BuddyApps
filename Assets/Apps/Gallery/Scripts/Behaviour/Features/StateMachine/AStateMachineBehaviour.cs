...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.Gallery namespace for every script file
/// </summary>
namespace BuddyApp.Gallery
{
    ...
    {
        private GalleryStateMachineManager mManager;
        private Animator mAnimator;

        internal GalleryStateMachineManager Manager { set { mManager = value; } }
