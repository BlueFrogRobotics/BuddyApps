...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.Quizz namespace for every script file
/// </summary>
namespace BuddyApp.Quizz
{
    ...
    {
        private QuizzStateMachineManager mManager;
        private Animator mAnimator;

        internal QuizzStateMachineManager Manager { set { mManager = value; } }
