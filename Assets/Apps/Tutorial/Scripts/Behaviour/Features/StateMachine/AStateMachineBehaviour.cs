...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.Tutorial namespace for every script file
/// </summary>
namespace BuddyApp.Tutorial
{
    ...
    {
        private TutorialStateMachineManager mManager;
        private Animator mAnimator;

        internal TutorialStateMachineManager Manager { set { mManager = value; } }
