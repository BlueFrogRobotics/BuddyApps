...
/// <summary>
/// Your script app namespace. You must keep BuddyApp.TacheAskUserKORIAN namespace for every script file
/// </summary>
namespace BuddyApp.TacheAskUserKORIAN
{
    ...
    {
        private TacheAskUserKORIANStateMachineManager mManager;
        private Animator mAnimator;

        internal TacheAskUserKORIANStateMachineManager Manager { set { mManager = value; } }
